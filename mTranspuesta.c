 ...
 *  Luego el programa se encargara por su cuenta de generar dos matrices con numeros semi-aleatorios, 
 *  una tercera de las mismas dimensiones con la matriz transpuesta de la segunda generada y una cuarta
 *  en la cual almacenar el resultado de la multiplicación entre la primera y la transpuesta.
